...
void DrawFish4() {
    ...
    glTranslatef(_fish4Xaxis, _fish4Yaxis, 0.0); //THIS IS FOR TRANSLATING THE FISH
...
void DrawFish3() {
    glScalef(1.3f, 1.0f, 0.0f); //THIS IS TO SCALE THE FISH
    glTranslatef(_fish3Xaxis, _fish3Yaxis, 0.0); //THIS IS FOR TRANSLATING THE FISH
    glPushMatrix();
...
void DrawFish2() {
    ...
    glTranslatef(_fish2Xaxis, _fish2Yaxis, 0.0);
    glRotatef(180.0, 0.0, 1.0, 0.0);
    glPushMatrix();
...
void intro()
{
    ...
    print(50, 190, 1, 1, 1, "-> Press ' n ' to enter into the scene", GLUT_BITMAP_HELVETICA_12);
    print(50, 175, 1, 1, 1, "-> Press ' e ' to exit", GLUT_BITMAP_HELVETICA_12);
...
int main(int argc, char** argv)
{
    ...
    glutTimerFunc(10, update, 0); //THIS IS THE UPDATE FUNCTOIN
    glutMainLoop();
    return 0;
}
